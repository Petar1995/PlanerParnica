...
namespace PlanerParnicaV2.Migrations
{
    ...
    [Migration("20200428174608_KontaktUpdate")]
    partial class KontaktUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlanerParnicaV2.Models.KorisnikParnica", b =>
                {
                    b.Property<string>("KorisnikId");

                    b.Property<int>("ParnicaId");

                    b.HasKey("KorisnikId", "ParnicaId");

                    b.HasIndex("ParnicaId");

                    b.ToTable("KorisnikParnica");
                });
            ...
            modelBuilder.Entity("PlanerParnicaV2.Models.KorisnikParnica", b =>
                {
                    b.HasOne("PlanerParnicaV2.Models.Korisnik", "Korisnik")
                        .WithMany("Parnice")
                        .HasForeignKey("KorisnikId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("PlanerParnicaV2.Models.Parnica", "Parnica")
                        .WithMany("Advokati")
